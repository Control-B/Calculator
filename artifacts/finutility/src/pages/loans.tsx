        ...
        <section className="py-24 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 md:px-8 relative z-10 text-center">
            ...
            <form onSubmit={handleSearch} className="max-w-2xl mx-auto relative flex items-center shadow-2xl rounded-full p-4 bg-white/10 backdrop-blur-md border border-white/20">
              ...
              <Input type="text" placeholder="e.g. mortgage on 400k at 6.5% for 30 years" className="h-16 pl-16 pr-56 text-lg rounded-full border-0 focus-visible:ring-0 focus-visible:ring-offset-0 bg-transparent text-white placeholder:text-white/60" value={query} onChange={(e) => setQuery(e.target.value)} />
